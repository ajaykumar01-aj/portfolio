...
import heroImage from '../../assets/images/IMG_0281.jpg';
  ...
  return (
    <section id="home" className="hero">
      <div className="hero-content">
        <FadeInLeft>
          <h1>Hi, I'm <span className="highlight">Ajay Kumar</span></h1>
        </FadeInLeft>
        
        <FadeInLeft delay={0.1}>
          <h2>I'm a <span className="typing">MERN stack Developer</span></h2>
        </FadeInLeft>
